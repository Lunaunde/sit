...
attribute @e[tag=new,tag=mount,limit=1] minecraft:generic.scale base set 0.0
attribute @e[tag=new,tag=mount,limit=1] minecraft:generic.movement_speed base set 0.000001
attribute @e[tag=new,tag=mount,limit=1] minecraft:generic.jump_strength base set 0.0
